...
<head>
  ...
  <title>Your Pharma | Dashboard</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      @guest
        ...
        <li class="nav-item">
          <a style="font-weight: bold; color: red" class="nav-link" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"> LOGOUT </a>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">Your Pharmacy</span>
    </a>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-2021 <a href="#">Your Pharma</a>.</strong>
    All rights reserved.
