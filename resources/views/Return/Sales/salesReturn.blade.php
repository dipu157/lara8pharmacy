        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form method='post' class='form-horizontal' id="salesReturnForm">
                    @csrf
...
<script type="text/javascript">
 ...
 <!-- Submit For Return Purchase  -->
    <script>
        $(document).on('click', '.salesReturnSubmit', function(e){
		e.preventDefault();
		var formval = $('#salesReturnForm')[0];
        var data = new FormData(formval);
        console.log(data);
                $.ajax({
                type: "POST",
                url: '{{ route('saveSalesReturn') }}',
                dataType: 'html',
                data: data,
                processData: false,
                contentType: false,
                ...
                success: function(response){
                //console.log(response);
                toastr.success('Sales Return Successfully');
                location.reload(true);
                },
                error: function(response){
                toastr.error('Sales Return Failed !! Try Again');
                console.error();
                }
            });
		});
