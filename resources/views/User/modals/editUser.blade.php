          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="card card-outline-primary">
                <div class="card-body">
                  <form action="#" method="post" enctype="multipart/form-data" accept-charset="utf-8" class="form-horizontal" id="edit_user_form">
                      @csrf
                      ...
                      <input type="hidden" name="id" id="user_id">
                        ...
                        <div class="row">
                          <!-- /.col -->
                          <div class="col-12">
                            <button type="submit" id="edit_user_btn" class="btn btn-primary btn-block">UPDATE</button>
                          </div>
                          <!-- /.col -->
                        </div>
                  </form>
