<div class="modal fade" id="addOtherExpenseModal" tabindex="-1" aria-labelledby="exampleModalLabel" data-bs-backdrop="static" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="#" method="post" accept-charset="utf-8" class="form-horizontal" id="add_Expense_form">
          @csrf
